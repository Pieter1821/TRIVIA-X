      ...
      <div className="bg-gradient-to-b from-purple-500 to-blue-500 w-96 p-6 rounded-lg shadow-lg text-white">
        ...
        <p className="text-lg mb-4">
          {totalQuestionsAnswered > 0 ? (
            <>
              Nice try, {userName}!
              <span role="img" aria-label="Thumbs Up" className="ml-2 text-2xl">👍</span>
            </>
          ) : (
            <>
              Thanks for giving it a shot!
              <span role="img" aria-label="Smiley Face" className="ml-2 text-2xl">😊</span>
            </>
          )}
        </p>
        <p className="text-2xl font-bold mb-4">
          Your Score: {score} out of {totalQuestionsAnswered}
        </p>
        <p className="text-lg mb-6">
          Keep it up! Trivia can be fun and challenging.
        </p>
        <button
